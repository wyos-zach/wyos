            ...
            <Card>
              ...
              <CardContent>
                <div className='flex flex-wrap gap-6'>
                  ...
                  <div className='space-y-2 w-full md:w-auto'>
                    <button className='button-base button-default'>
                      Base Button
                    </button>
                    <div className='text-xs text-muted-foreground'>
                  ...
                  <div className='space-y-2 w-full md:w-auto'>
                    <button className='button-base button-outline'>
                      Outline Base
                    </button>
                    <div className='text-xs text-muted-foreground'>
                  ...
                  <div className='space-y-2 w-full md:w-auto'>
                    <button className='button-base button-ghost'>
                      Ghost Base
                    </button>
                    <div className='text-xs text-muted-foreground'>
...
<button className="button-base button-ghost">Ghost Base</button>`}</code>
                ...
                <div className='p-4 border rounded-md bg-yellow-50 dark:bg-yellow-950 dark:border-yellow-800'>
                  ...
                  <p>
                    For consistency, prefer using the Button component from
                    '@/components/ui/button' when possible. The CSS class
                    buttons are available for specific use cases where the
                    component approach might not be suitable.
                  </p>
                </div>
              </div>
            </CardContent>
