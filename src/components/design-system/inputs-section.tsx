...
export function InputsSection() {
  ...
  return (
    <section id="inputs" className="space-y-6 py-8 border-t">
      <H2>Inputs & Forms</H2>
              ...
              <CardContent className="grid gap-6">
                ...
                <div className="grid w-full max-w-sm items-center gap-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input id="with-icon" className="pl-8" placeholder="Search..." />
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <button type="submit" className="button-base button-default">
                      Submit
                    </button>
                  </form>
                </Form>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  <h4 className="text-lg font-semibold mb-2">Basic Imports</h4>
...
import { Switch } from '@/components/ui/switch';`}</code>
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-2">Basic Input with Label</h4>
                  <pre className="bg-muted p-4 rounded-md overflow-x-auto">
  ...
  <Input type="email" id="email" placeholder="Email" />
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-2">React Hook Form Integration</h4>
                  <pre className="bg-muted p-4 rounded-md overflow-x-auto">
  ...
  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
    ...
    <button type="submit">Submit</button>
                ...
                <div className="p-4 border rounded-md bg-yellow-50 dark:bg-yellow-950 dark:border-yellow-800">
                  ...
                  <p>Always use the Form components with React Hook Form and Zod for validation to ensure consistent form handling throughout the application. This provides type safety, validation, and a consistent user experience.</p>
                </div>
              </div>
            </CardContent>
          </Card>
