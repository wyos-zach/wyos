          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-2">Basic Dialog Usage</h4>
                  <pre className="bg-muted p-4 rounded-md overflow-x-auto">
                    <code>{`<Dialog>
  <DialogTrigger asChild>
    <Button variant="outline">Open Dialog</Button>
  ...
  <DialogContent className="sm:max-w-[425px]">
    ...
    <DialogFooter>
      <Button type="submit">Save changes</Button>
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-2">Alert Dialog Import</h4>
                  <pre className="bg-muted p-4 rounded-md overflow-x-auto">
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-2">Alert Dialog Usage</h4>
                  <pre className="bg-muted p-4 rounded-md overflow-x-auto">
                    <code>{`<AlertDialog>
  <AlertDialogTrigger asChild>
  ...
  <AlertDialogContent>
    ...
    <AlertDialogFooter>
      ...
      <AlertDialogAction>Continue</AlertDialogAction>
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-2">Sheet Import (Side Panel)</h4>
                  <pre className="bg-muted p-4 rounded-md overflow-x-auto">
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-2">Drawer Import (Bottom Panel)</h4>
                  <pre className="bg-muted p-4 rounded-md overflow-x-auto">
                ...
                <div className="p-4 border rounded-md bg-yellow-50 dark:bg-yellow-950 dark:border-yellow-800">
                  ...
                  <p>Choose the appropriate dialog type based on the context:</p>
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li><strong>Dialog:</strong> For general modal interactions</li>
                    <li><strong>AlertDialog:</strong> For confirmations and destructive actions</li>
                    <li><strong>Sheet:</strong> For side panels with more complex forms or content</li>
                    <li><strong>Drawer:</strong> For mobile-friendly bottom sheets</li>
                  </ul>
                </div>
              </div>
            </CardContent>
