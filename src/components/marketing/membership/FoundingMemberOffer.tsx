        ...
        >
          ...
          >
            ...
            <div className="relative z-10 rounded-xl p-8 md:p-10">
              ...
              >
                Founding Member <span className="text-blue-400">Opportunity</span>
              </motion.h2>
              ...
              >
                For the first 50 members only — <span className="text-blue-400 font-medium">be part of something real from the start</span>
              </motion.p>
              ...
              <div className="mt-12 flex flex-col items-stretch justify-center gap-8 md:flex-row">
                ...
                >
                  <div className="h-full rounded-xl bg-gradient-to-b from-black/60 to-black/95 p-6 md:p-8">
                    <h3 className="font-heading text-2xl font-bold text-white">Monthly</h3>
                    <p className="mt-2 text-zinc-400">Flexible option</p>
                    
                    <div className="my-6 flex items-baseline">
                      <span className="font-heading text-5xl font-bold text-white">$25</span>
                      <span className="ml-1 text-zinc-400">/month</span>
                    </div>
                    
                    <Link href="/register" className="mt-6 block">
                      <ShinyButton className="w-full">Choose Monthly</ShinyButton>
                    </Link>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="h-full rounded-xl bg-gradient-to-b from-black/60 to-black/95 p-6 md:p-8">
                    <h3 className="font-heading text-2xl font-bold text-white">Annual</h3>
                    <p className="mt-2 text-zinc-400">Save $120</p>
                    
                    <div className="my-6 flex items-baseline">
                      <span className="font-heading text-5xl font-bold text-white">$180</span>
